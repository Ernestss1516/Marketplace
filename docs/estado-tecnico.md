...
> Fecha: 2026-07-01 · Rama: `main` · Último commit: RL5.1-A — prefill de ubicación del perfil en wizard de creación + robustez geocoding (timeout 3s, fallback sin CP, logs)
