...
test.describe('B4 — sugerencias del buscador de portada', () => {
  ...
  test('elegir una etiqueta CON categoría lleva a la URL anidada de A1 + ?tags=', async ({
    page,
  }) => {
  ...
  test('elegir una etiqueta SIN categoría lleva a /busqueda?tags=', async ({ page }) => {
    await page.goto('/');
    await teclear(page, 'garant');
  ...
  test('la provincia elegida viaja con la etiqueta', async ({ page }) => {
    await page.goto('/');
  ...
  test('Enter SIN elegir sugerencia hace la búsqueda de texto libre de siempre', async ({
    page,
  }) => {
    await page.goto('/');
  ...
  test('la salida de escape del desplegable también busca texto libre', async ({ page }) => {
    await page.goto('/');
    await teclear(page, 'garant');
  ...
  test('flecha abajo + Enter elige la primera sugerencia', async ({ page }) => {
    await page.goto('/');
